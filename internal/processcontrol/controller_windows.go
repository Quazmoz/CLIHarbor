...
func newController() (Controller, error) {
	...
	controller := &windowsController{job: syscall.Handle(handle)}
...
func (c *windowsController) Configure(cmd *exec.Cmd) error {
	if cmd == nil {
...
func (c *windowsController) AfterStart(cmd *exec.Cmd) error {
...
func (c *windowsController) Cancel(cmd *exec.Cmd) error {
	c.mu.Lock()
	defer c.mu.Unlock()
